...
SUPPORT_GROUP = int(environ.get("SUPPORT_GROUP", "-1002522308350"))
...
# URL Generation
BIND_ADDRESS = environ.get("WEB_SERVER_BIND_ADDRESS", "file-link-fr1i.onrender.com/")   ##without https:// paste the base url here 
